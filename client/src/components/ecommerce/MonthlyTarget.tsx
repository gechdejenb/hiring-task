  ...
  useEffect(() => {
    if (feedbacks) {
      ...
      const highestPercentage = Math.max(
        Number(calculatedPercentages.positive),
        Number(calculatedPercentages.neutral),
        Number(calculatedPercentages.negative)
      );

      setSentimentPercentages(calculatedPercentages);
      setSeriesData([highestPercentage]);
    }
  }, [feedbacks]);
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-500 text-theme-xs dark:text-gray-400">
              Sentiment distribution of feedbacks
            </p>
          </div>
        ...
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          The highest sentiment percentage is displayed.
        </p>
      </div>
